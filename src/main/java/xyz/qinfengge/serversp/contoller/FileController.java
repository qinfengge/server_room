...
public class FileController {
    ...
    public Result<?> upload(MultipartFile file) throws IOException {
        ...
        String path = System.getProperty("user.dir") + "/src/main/resources/files/" +flag + "_" +filename;
        FileUtil.writeBytes(file.getBytes(),path);
        return Result.success(ip + ":" + port + "/file/download/" + flag);  //返回文件路径
    }
